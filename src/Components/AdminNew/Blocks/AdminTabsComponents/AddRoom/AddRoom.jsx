    ...
    return (
        <div className={classes.addData}>
            ...
            <Form actionUrl={`${server}/api/addRooms`} method="post" needNavigate={true} resetAll={resetAll} initialValues={initialValues} onTourAdded={onTourAdded}>
                ...
                <label>Адрес номера</label>
                <input name="adress" type="text" placeholder="Адрес номера" required />

                <label>Ссылка из карт</label>
                <input name="adressLink" type="text" placeholder="Ссылка из карт" required />
