...
const handleRemoveEntry = index => setEntries(current => current.filter((_, i) => i !== index));
  ...
  return (
    <div className={classes.addData}>
      ...
      <Form
        actionUrl={`${server}/api/addOnedayTour`}
        method="post"
        needNavigate={true}
        resetAll={resetAll}
