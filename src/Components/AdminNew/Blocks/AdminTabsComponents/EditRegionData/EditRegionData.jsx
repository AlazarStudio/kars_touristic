    ...
    fetch(`${server}/api/getOneRegion/${id}`)
      ...
      .then((data) => {
        setSelectedPlace({
          ...
          coverImgPath: Array.isArray(data.coverImgPath)
            ? data.coverImgPath
            : [],
          backgroundImgPath: Array.isArray(data.backgroundImgPath)
            ? data.backgroundImgPath
            : [],
        });
      })
      ...
      {selectedPlace && (
        <div className={classes.addData}>
          ...
          >
            ...
            ></textarea>
     <label>Описание места 2</label>
            <textarea
              name="descriptionSecond"
              placeholder="Описание места"
              value={selectedPlace.descriptionSecond}
              onChange={(e) =>
                setSelectedPlace((prevState) => ({
                  ...prevState,
                  description: e.target.value,
            ...
            <div className={classes.imgBlock}>
              {Array.isArray(selectedPlace.iconPath) &&
            ...
            <div className={classes.imgBlock}>
              {Array.isArray(selectedPlace.coverImgPath) &&
            ...
            <div className={classes.imgBlock}>
              {Array.isArray(selectedPlace.backgroundImgPath) &&
