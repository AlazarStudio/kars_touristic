...
function AddMultidayTours({ children, activeTab, fetchRegions, setIsDirty, ...props }) {
    return (
        <div className={classes.addData}>
            ...
            <Form actionUrl="http://localhost:5002/api/addRegion" method="post" fetchRegions={fetchRegions} setIsDirty={setIsDirty}>
                ...
                <label>День 1</label>
                <textarea name="description" placeholder="День 1" required />

                <label>День 2</label>
                <textarea name="description" placeholder="День 2" required />

                <label>День 3</label>
                <textarea name="description" placeholder="День 3" required />

                <label>День 4</label>
                <textarea name="description" placeholder="День 4" required />
