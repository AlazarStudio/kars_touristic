...
import classes from './DuplicateOneDayTourModal.module.css';

function DuplicateOneDayTourModal({ isOpen, onClose, tour, refreshTours }) {
    ...
    const duplicateTour = async (region) => {
        ...
        try {
            const response = await axios.post(`${server}/api/dublicateOnedayTour`, duplicatedTour, {
                headers: {
...
export default DuplicateOneDayTourModal;
