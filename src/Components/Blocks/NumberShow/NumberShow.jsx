        ...
        <CenterBlock>
          <WidthBlock>
            <div className={classes.room}>
              <div className={classes.numberInfo}>
                <div className={classes.roomTitle}>
                  ...
                  <div className={classes.roomInfoData}>
                    ...
                    <div className={classes.roomInfoData_feedback}>
                      10 отзывов
                    </div>
                    <div className={classes.roomInfoData_adress}>
                      Измайловское шоссе, 71к4Г-Д
                    </div>
                ...
                <div className={classes.numberInfo_right}>
                  ...
                  <div className={classes.numberInfo_right__desc___items}>
                    <div
                      className={
                        classes.numberInfo_right__desc___items____block
                      }
                    >
                      <div
                        className={
              ...
              {user && (
                <Add_Feedback userID={user._id} roomID={idRoom} />
              )}
