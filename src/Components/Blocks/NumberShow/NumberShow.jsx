  ...
  const toggleFavorite = async () => {
    ...
    try {
      const updatedLikes = isFavorite
        ? user.likes.filter((id) => id !== room._id)
        : [...(user.likes || []), room._id];
      ...
      const res = await fetch(`${server}/api/userUpdate`, {
        ...
        body: JSON.stringify({ likes: updatedLikes }), // <-- именно likes!
      });
      ...
      if (res.ok) {
        ...
        alert(data.message || (isFavorite ? 'Удалено из избранного' : 'Добавлено в избранное'));
      } else {
          ...
          <div className={classes.numberInfo}>
            ...
            <div className={classes.numberInfo_left}>
              ...
              <div className={classes.numberInfo_bron}>
                <div
                  className={classes.numberInfo_bron_dop}
