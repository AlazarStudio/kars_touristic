...
function Hotels({ children, handleOpen, isSimillar, user, setUser, ...props }) {
  ...
  regionsName && hotel
    ? (regionNameData = getTitleByLink(regionsName, hotel.region))
    : null;
      ...
      {hotel ? (
        <>
          <div
            ...
            style={{
              backgroundImage: `url('${server}/refs/${
                hotel.mainPhoto ? hotel.mainPhoto : hotel.galery[0]
              }')`,
            }}
          >
            <CenterBlock>
                ...
                <div className={classes.separateBlock}>
                  <div className={classes.hotelInfo}>
                    ...
                    <div className={classes.hotelInfo_stars_links}>
                      <div
                        className={classes.hotelStars}
                        dangerouslySetInnerHTML={{
                          __html: getStars(hotel.stars),
                        }}
                      ></div>
              ...
              <div className={classes.hotelItems}>
                {hotel.items.map((item, index) => (
                  <div key={index} className={classes.hotelItems_elem}>
                    ...
                    <div className={classes.hotelItems_elem__title}>
                      {item.title}
                    </div>
              ...
              <WidthBlock>
                <div className={classes.aboutHotel_info}>
                  ...
                  <div className={classes.aboutHotel_info__right}>
                    <div className={classes.aboutHotel_info__right___title}>
                      {hotel.title}
                    </div>
          ...
          <CenterBlock>
            <WidthBlock>
              ...
              {rooms.length > 0 ? (
                <>
                  ...
                  <HotelNumber
                    ...
                    hotel={hotel}
                    user={user}
                    setUser={setUser} // <<< ВАЖНО: добавляем это
                  />
                </>
              ) : null}
              ...
              {hotel && (
                <>
                  {user ? (
                    <Add_Feedback userID={user._id} hotelID={hotel._id} />
                  ) : (
