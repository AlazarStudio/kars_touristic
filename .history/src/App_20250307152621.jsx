  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/admin1" element={<Admin_Page />} />
          <Route path="/admin1/:id" element={<Admin_Page />} />
          <Route path="/admin1/:id/:title" element={<Admin_Page />} />
          <Route path="/admin1/:id/:title/:type" element={<Admin_Page />} />
          <Route path="/admin1/:id/:title/:type/:add" element={<Admin_Page />} />
          <Route
            path="/admin1/:id/:title/:type/:add/:idToEdit"
            element={<Admin_Page />}
          />
          <Route
            path="/admin1/:id/:title/:type/:add/:idToEdit/:roomId"
            element={<Admin_Page />}
          />
      </Routes>
    </>
