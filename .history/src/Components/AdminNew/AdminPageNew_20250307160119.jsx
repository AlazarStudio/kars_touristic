                ...
                <div className={classes.admin}>
                    ...
                    <div className={classes.admin_data}>
                        ...
                        <Link to={`/admin1/addUsers`}
                                        className={`${classes.admin_data__nav___item} ${isActive('addUsers')} ${classes.nav_title}`}
                            ...
                            {user.role === 'admin' ?
                                <>
                                    ...
                                    <span className={classes.nav_title}>Брони</span>
                                       <Link to={'/admin1/brons'} className={classes.admin_header__items___item} onClick={() => setActiveTab('brons')}>
                                        Брони туров
                                        {/* {
                                            brons && brons.length > 0 ?
                                                <div className={classes.admin_header__nonAccessData}>{brons.length}</div> :
                                    ...
                                    <span className={classes.nav_title}>Неподтвержденные туры</span>
                                         <Link to={'/admin/moderedAuthorTours'} className={classes..nav_title} onClick={() => setActiveTab('moderedAuthorTours')}>
                                        Неподтвержденные туры
                                        {
                                            unmoderatedTourCount ?
                                                <div className={classes.admin_header__nonAccessData}>{unmoderatedTourCount}</div> :
