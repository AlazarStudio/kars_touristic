...
import { CheckBox, Class } from '@mui/icons-material';
        ...
        <div className={classes.containerUsersTable}>
            ...
            ? agents.map((item, index) => (
                ...
                >
                  ...
                  >
                    <div className={classes.containerUsersTableBottomEl}>{item.name}</div>
                    <div className={classes.containerUsersTableBottomEl}>{item.email}</div>
                    <div className={classes.containerUsersTableBottomEl}>{item.phone}</div>
                  </Link>
                </div>
              ))
            : null}
