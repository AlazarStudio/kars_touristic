    ...
    return (
        <div className={classes.multidayTours}>
            <div className={classes.multidayTours_top}>
                ...
                <span className={classes.multidayTours_top__date}>{new Date().toLocaleDateString('ru-RU', { weekday: 'short', day: 'numeric', month: 'long' })}</span>
                <span className={classes.multidayTours_top__user}></span>
