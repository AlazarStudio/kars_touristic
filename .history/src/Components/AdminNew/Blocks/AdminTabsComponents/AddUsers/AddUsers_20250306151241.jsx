...
function AddUsers({ setActiveTab }) {
    ...
    return (
        <div className={classes.container}>
           ...
           <div className={classes.containerUsersTopLeft}>   <span><CheckBox/> <span>Выбрать все</span></span>
           <button>Зарегистрировать пользователя</button></div>
           <div className={classes.containerUsersTopRight}></div>
