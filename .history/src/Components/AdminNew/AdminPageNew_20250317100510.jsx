...
{openSections.pages && (
    <div className={classes.admin_data__nav___item}>
        ...
        {/* Регион */}
        <div
            className={`${isActive('addRegion')} ${isActiveEdit(
                'edit'
            )} ${classes.hoverBlock}`}
        ...
        {openSections.regions && (
            <div className={classes.admin_data__nav___item____desc}>
                {user.role === 'admin' ? (
                    <Link
                        to={'/admin/addRegion'}
                        className={`${classes.admin_data__nav___item____subItem} ${isActive('addRegion')}`}
        ...
        {/* О нас */}
        <div
            className={`${isActive('addAboutCompany')} ${isActive(
                'addOurTeam'
            )} ${isActive('addOurMission')} ${classes.hoverBlock}`}
        ...
        {openSections.about && (
            <div className={classes.admin_data__nav___item____desc}>
                <Link
                    ...
                    className={`${classes.admin_data__nav___item____subItem} ${isActive('addAboutCompany')}`}
                ...
                <Link
                    to={`/admin/addOurTeam`}
                    className={`${classes.admin_data__nav___item____subItem} ${isActive('addOurTeam')}`}
                ...
                <Link
                    ...
                    className={`${classes.admin_data__nav___item____subItem} ${isActive('addOurMission')}`}
