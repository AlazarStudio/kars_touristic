...
{openSections.pages && (
    <div className={classes.admin_data__nav___item}>
        ...
        {/* Регион */}
        <div className={classes.hoverBlock} onClick={() => toggleSection('regions')}>
            Регион
        </div>
        ...
        {/* О нас */}
        <div className={classes.hoverBlock} onClick={() => toggleSection('about')}>
            О нас
        </div>
        {openSections.about && (
            <div className={classes.admin_data__nav___item____desc}>
                <Link to="/admin/addAboutCompany" onClick={() => setActiveTab('addAboutCompany')}>
                    О компании
                </Link>
                <Link to="/admin/addOurTeam" onClick={() => setActiveTab('addOurTeam')}>
                    Наша команда
                </Link>
                <Link to="/admin/addOurMission" onClick={() => setActiveTab('addOurMission')}>
                    Наша миссия
                </Link>
            </div>
        )}
        ...
        {/* Трансфер */}
        <div className={classes.hoverBlock} onClick={() => toggleSection('transfer')}>
            Трансфер
        </div>
        {openSections.transfer && (
            <Link to="/admin/addTransfer" className={classes.admin_data__nav___item} onClick={() => setActiveTab('addTransfer')}>
                Добавить Трансфер
            </Link>
        )}

        {/* FAQ */}
        <div className={classes.hoverBlock} onClick={() => toggleSection('faq')}>
            FAQ
        </div>
        {openSections.faq && (
            <Link to="/admin/addFAQ" className={classes.admin_data__nav___item} onClick={() => setActiveTab('addFAQ')}>
                Добавить FAQ
            </Link>
        )}

        {/* Контакты */}
        <div className={classes.hoverBlock} onClick={() => toggleSection('contacts')}>
            Контакты
        </div>
        {openSections.contacts && (
            <Link to="/admin/addContacts" className={classes.admin_data__nav___item} onClick={() => setActiveTab('addContacts')}>
                Добавить Контакты
            </Link>
        )}

        {/* Турагентам */}
        <div className={classes.hoverBlock} onClick={() => toggleSection('touragents')}>
            Турагентам
        </div>
        {openSections.touragents && (
            <Link to="/admin/addTuragent" className={classes.admin_data__nav___item} onClick={() => setActiveTab('addTuragent')}>
                Добавить Турагента
            </Link>
        )}
    </div>
                  ...
                  <span className={classes.nav_title}>Брони</span>
                  <Link
                    to={'/admin/brons'}
                  ...
                  <Link
                    ...
                    onClick={() => {
                      ...
                      setOpenSection('addHotelAndApartments');
                    }}
                  >
                    Брони отелей
                  </Link>
                  ...
                  >
                    <span className={classes.nav_title}>
                      Неподтвержденные туры
                    </span>
