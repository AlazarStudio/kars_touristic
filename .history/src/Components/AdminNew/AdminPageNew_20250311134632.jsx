                ...
                <>
                  <div className={`${classes.admin_data__nav___item}`}>
                    ...
                    {openSection === 'about' && (
                      <div className={classes.admin_data__nav___item____desc}>
                        <Link
                          to={`/admin1/addAboutCompany`}
                          className={`${
                            classes.admin_data__nav___item____subItem
                          } ${isActive('addAboutCompany')}`}
                          onClick={() => setActiveTab('addAboutCompany')}
                        >
                          О компании
                        </Link>
                        <Link
                          to={`/admin1/addOurTeam`}
                          className={`${
                            classes.admin_data__nav___item____subItem
                          } ${isActive('addOurTeam')}`}
                        ...
                        <Link
                          to={`/admin1/addOurMission`}
                          className={`${
                            classes.admin_data__nav___item____subItem
                          } ${isActive('addOurMission')}`}
                  ...
                  <Link
                    to={`/admin1/addHotelAndApartments`}
                    className={`${classes.admin_data__nav___item} ${isActive(
