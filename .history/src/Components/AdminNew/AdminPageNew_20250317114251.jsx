    ...
    <div className={classes.admin_data__nav___item1}>
      ...
      <div className={classes.admin_header}>
        <div className={classes.admin_data__info_top}>
          ...
          >
            <img src={user?.img || "/default-avatar.png"} alt="Avatar" />
            <span>
              {user ? (
                <>
        ...
        {/* Выпадающее меню с данными пользователя */}
        {isUserDropdownOpen && user && (
          <div className={classes.userDropdown}>
            <img
              src={user.img || "/default-avatar.png"}
              alt="User Avatar"
              className={classes.userDropdownAvatar}
            />
            <p className={classes.userDropdownEmail}>{user.email}</p>
            <p className={classes.userDropdownPhone}>
