  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/admin1" element={<AdminPageNew />} />
          <Route path="/admin1/:id" element={<AdminPageNew />} />
          <Route path="/admin1/:id/:title" element={<AdminPageNew />} />
          <Route path="/admin1/:id/:title/:type" element={<AdminPageNew />} />
          <Route path="/admin1/:id/:title/:type/:add" element={<AdminPageNew />} />
          <Route
